...
*/
			...
			if(g==0)handle2 = fopen("lynx48-1.rom",  "rb" );
			if(g==1)handle2 = fopen("lynx48-2.rom",  "rb" );
			if(g==2)handle2 = fopen("none",  "rb" );
			if(g==3)handle2 = fopen("none",  "rb" );
			if(g==4)handle2 = fopen("none",  "rb" );
			if(g==5)handle2 = fopen("none",  "rb" );
			if(g==6)handle2 = fopen("none",  "rb" );
			if(g==7)handle2 = fopen("none",  "rb" );



//			handle2 = fopen((const char *) nfil,  "rb" );
		//	handle2 = fopen("lynx48-1.rom",  "rb" );
...
int load_lynx_rom()
{
	...
	//Save roms to C array text fileS for BurNin' da r0mzZ0rz
//	saveCRom();

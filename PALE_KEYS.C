...
void CheckKeys(void)
{
	...
	if (key[SDLK_F3]) set_speed(emu_speed-1);
	if (key[SDLK_F4]) set_speed(emu_speed+1);
...
//	if (key[SDLK_CAPSLOCK]) z80ports_in[0x0080] &= 0xF7; //NOT WORKING , LEADS TO REPEATING KEY
	...
	if (key[SDLK_4]) z80ports_in[0x0180] &= 0xFD;// 02
	if (key[SDLK_e]) z80ports_in[0x0180] &= 0xFB;// 04
	if (key[SDLK_x]) z80ports_in[0x0180] &= 0xF7;// 08
	if (key[SDLK_d]) z80ports_in[0x0180] &= 0xEF;// 10
	...
	if (key[SDLK_AT]) z80ports_in[0x0580] &= 0xEF;
...
//	if ((key[SDLK_RSHIFT]) || (key[SDLK_LSHIFT])) z80ports_in[0x0080] &= 0x7F;
	...
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT
		z80ports_in[0x0180] &= 0xFE;// 3
	}
	if (k=='4') z80ports_in[0x0180] &= 0xFD;
	if(k=='$')
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT
		z80ports_in[0x0180] &= 0xFD;// 4
	}
// 02
...
//	if ((key[SDLK_RCTRL]) || (key[SDLK_LCTRL])) z80ports_in[0x0280] &= 0xBF;
	...
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT
		z80ports_in[0x0580] &= 0xFE;// 7
	}
	if (k=='8') z80ports_in[0x0580] &= 0xFD;
	if(k=='(')
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT
		z80ports_in[0x0580] &= 0xFD;// 8
	}
...
// unsure about these
	...
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT
		z80ports_in[0x0780] &= 0xF7;// .
	}
	if (k==';') z80ports_in[0x0780] &= 0xDF;
	if (k=='+')
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT ;
		z80ports_in[0x0780] &= 0xDF;
	}
...
//	if (k=='@') z80ports_in[0x0580] &= 0xEF;
	...
	if (k=='@') z80ports_in[0x0880] &= 0xFD;
	if (k=='\\')
	{
		z80ports_in[0x0080] &= 0x7F;//SHIFT @
		z80ports_in[0x0880] &= 0xFD;
	}
...
void pump_string(char *s)
{
	...
	for(f=0;f<5;f++)	//Give it time to settle
		z80_emulate(emu_cycles);
